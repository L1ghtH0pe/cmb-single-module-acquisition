...
struct MetricsSnapshot {
    ...
    std::uint64_t send_deadline_us{0};
    std::uint64_t send_deadline_miss_count{0};
    std::uint64_t send_max_late_us{0};
    std::uint64_t send_schedule_late_avg_us{0};
    std::uint64_t send_schedule_late_max_us{0};
    std::uint64_t send_work_avg_us{0};
    std::uint64_t send_work_max_us{0};
    std::uint64_t send_encode_avg_us{0};
    std::uint64_t send_encode_max_us{0};
    std::uint64_t send_socket_avg_us{0};
    std::uint64_t send_socket_max_us{0};
    ...
    std::uint64_t recv_parse_avg_us{0};
    std::uint64_t recv_parse_max_us{0};
    std::uint64_t capture_queue_capacity{0};
    std::uint64_t capture_queue_high_water{0};
    std::uint64_t capture_queue_overrun_count{0};
    std::uint64_t storage_write_avg_us{0};
    std::uint64_t storage_write_max_us{0};
